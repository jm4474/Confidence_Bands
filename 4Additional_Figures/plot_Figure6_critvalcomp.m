...
% Pointwise
pw_critval    = norminv(1-alphas'/2);       
                                % (1-alpha) quantile of |N(0,1)|

% Sidak
sidak_critval = norminv((1+bsxfun(@power, 1-alphas', 1./ks))/2);    
                                % (1-alpha)^(1/k) quantile of |N(0,1)|

% Bonferroni
bonf_critval  = norminv(1-bsxfun(@rdivide, alphas', ks)/2);          
                                % (1-alpha/k) quantile of |N(0,1)|
